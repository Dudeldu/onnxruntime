...
ORT_API_STATUS_IMPL(CreateSharedAllocator, _In_ const OrtMemoryInfo* mem_info, _In_ const OrtArenaCfg* arena_cfg,
                    _Outptr_ OrtAllocator** out);
ORT_API_STATUS_IMPL(AddSharedAllocator, _Inout_ OrtEnv* env, _Inout_ OrtAllocator* allocator);
}  // namespace OrtApis
